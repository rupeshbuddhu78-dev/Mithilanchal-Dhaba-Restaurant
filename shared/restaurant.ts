...
export const DEFAULT_MENU_SEED = [
  { category: { name: "Thalis & Combos", slug: "thalis-combos", sortOrder: 1, imageUrl: null }, items: [
    { name: "Mithilanchal Veg Thali", slug: "mithilanchal-veg-thali", description: "A generous vegetarian platter with seasonal accompaniments.", pricePaise: 24900, imageUrl: null, isVegetarian: true, isFeatured: true },
    { name: "Comfort Dal Rice Bowl", slug: "comfort-dal-rice-bowl", description: "Steaming rice with a homestyle dal preparation.", pricePaise: 16900, imageUrl: null, isVegetarian: true, isFeatured: false },
  ] },
  { category: { name: "Tandoor & Starters", slug: "tandoor-starters", sortOrder: 2, imageUrl: null }, items: [
    { name: "Paneer Tikka", slug: "paneer-tikka", description: "Char-grilled paneer with a fragrant tandoori marinade.", pricePaise: 28900, imageUrl: null, isVegetarian: true, isFeatured: true },
    { name: "Masala Papad", slug: "masala-papad", description: "Crisp papad topped with a bright, spiced salad.", pricePaise: 7900, imageUrl: null, isVegetarian: true, isFeatured: false },
  ] },
  { category: { name: "Signature Curries", slug: "signature-curries", sortOrder: 3, imageUrl: null }, items: [
    { name: "Paneer Makhani", slug: "paneer-makhani", description: "Silky tomato and cashew gravy finished with paneer.", pricePaise: 31900, imageUrl: null, isVegetarian: true, isFeatured: true, customisation: [{ id: "spice", label: "Spice level", required: true, choices: [{ id: "mild", label: "Mild", priceDeltaPaise: 0 }, { id: "regular", label: "Regular", priceDeltaPaise: 0 }, { id: "hot", label: "Hot", priceDeltaPaise: 0 }] }] },
    { name: "Seasonal Vegetable Curry", slug: "seasonal-vegetable-curry", description: "Market vegetables cooked in a balanced house masala.", pricePaise: 24900, imageUrl: null, isVegetarian: true, isFeatured: false },
  ] },
] as const;
