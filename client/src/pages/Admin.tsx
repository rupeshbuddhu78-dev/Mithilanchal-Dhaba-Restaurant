...
import { ActiveDeliveryAssignment } from "@/components/ActiveDeliveryAssignment";
...
import { AdminDeliveryTracking } from "@/components/AdminDeliveryTracking";
...
export default function Admin() {
  ...
  const activeTrackingOrderId = orders.data?.find(order => order.status === "rider_assigned" || order.status === "out_for_delivery")?.id;
